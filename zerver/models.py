...
class Realm(models.Model):  # type: ignore[django-manager-missing] # django-stubs cannot resolve the custom CTEManager yet https://github.com/typeddjango/django-stubs/issues/1023
    ...
    ORG_TYPES: Dict[str, OrgTypeDict] = {
        ...
        "business": {
            ...
            "hidden": False,
            "display_order": 1,
            "onboarding_zulip_guide_url": "https://www.onehash.ai",
        },
        "opensource": {
    ...
    UPGRADE_TEXT_PLUS = gettext_lazy("Available on Connect Plus. Upgrade to access.")
    ...
    ALL_PLAN_TYPES = {
        ...
        PLAN_TYPE_ONEHASH_FREE: "free-plan",
        PLAN_TYPE_ONEHASH_STANDARD: "standard-plan",
    }
