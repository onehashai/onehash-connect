...
1. Paste an emoji copied from outside of Connect directly into the compose box.
...
You can configure OneHash Connect to convert emoticons into emoji, so that, e.g., `:)`
